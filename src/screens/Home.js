...
const App = () => {
  const categories = [
    ...
    { name: 'Beauty',
       image: 'https://m.media-amazon.com/images/I/51aiuoKu5HL._AC_UL480_FMwebp_QL65_.jpg' },
  ...
  const products = [
    ...
    { name: '', image: 'https://images-eu.ssl-images-amazon.com/images/G/31/img21/june/CE/GW/QC/PC/PC_QuadCard_Boult_0.5x._SY116_CB553870684_.jpg' },
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon name="notifications" size={24} color="#fff" style={styles.filterIcon} />
    </View>
